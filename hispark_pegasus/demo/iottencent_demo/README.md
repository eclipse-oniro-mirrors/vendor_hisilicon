...
![输入图片说明](../doc/figures/iottencent_demo/035iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/036iottencent.png)

2.2 在产品列表栏进入刚刚创建的新产品->设备列表->添加设备->创建新设备：设备名称，设备备注（选填），使用物联网通信提供密钥->保存->复制保存生成的密钥->开始管理设备（可以看到设备相应信息）。

![输入图片说明](../doc/figures/iottencent_demo/037iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/038iottencent.png)

2.3 添加设备，同时查看设备相应信息。

![输入图片说明](../doc/figures/iottencent_demo/039iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/040iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/041iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/042iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/043iottencent.png)
...
![输入图片说明](../doc/figures/iottencent_demo/044iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/045iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/046iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/047iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/048iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/049iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/050iottencent.png)

2.5 完成2.3步骤后，可以在腾讯云设备列表里面看到设备状态显示已激活，开始腾讯云与MQTT工具之间的通信。

![输入图片说明](../doc/figures/iottencent_demo/051iottencent.png)

2.6 MQTT.fx-1.7.1工具订阅腾讯云的topic，腾讯云下发指令。

![输入图片说明](../doc/figures/iottencent_demo/052iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/053iottencent.png)

2.7 在腾讯云网页端点击“在线调试”。

![输入图片说明](../doc/figures/iottencent_demo/054iottencent.png)

2.8 可以在MQTT.fx-1.7.1工具中看到腾讯云网页端发过来的消息。

![输入图片说明](../doc/figures/iottencent_demo/055iottencent.png)

2.9 MQTT.fx-1.7.1工具发布腾讯云到的topic，在设备影子中查看发布到腾讯云的消息。

![输入图片说明](../doc/figures/iottencent_demo/056iottencent.png)
...
![输入图片说明](../doc/figures/iottencent_demo/057iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/058iottencent.png)
...
![输入图片说明](../doc/figures/iottencent_demo/059iottencent.png)

3.3 开发者工具下载与安装：https://developers.weixin.qq.com/miniprogram/dev/devtools/download.html。

![输入图片说明](../doc/figures/iottencent_demo/060iottencent.png)

3.4 下载安装完成后，打开微信开发工具，导入提供的微信小程序软件包[获取微信小程序代码](https://gitee.com/leo593362220/Hi3861OpenHarmony)。并填入自己的APPID,后端服务选择微信云开发。

![输入图片说明](../doc/figures/iottencent_demo/061iottencent.png)

3.5 使用微信开发者工具打开工程后需要修改project.config.json文件中appid,projectname修改成自己的。

![输入图片说明](../doc/figures/iottencent_demo/062iottencent.png)

3.6 获取secretId和secretKey，在腾讯云->产品列表->搜索栏搜索访问密钥->访问密钥->继续使用->可以看到secretId和secretKey，复制在xxxx.txt文件，后面需要。

![输入图片说明](../doc/figures/iottencent_demo/063iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/064iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/065iottencent.png)

3.7 环境ID配置并获取环境ID,复制在xxx.txt文件，后面需要。

![输入图片说明](../doc/figures/iottencent_demo/066iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/067iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/068iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/069iottencent.png)
...
![输入图片说明](../doc/figures/iottencent_demo/071iottencent.png)

3.9 配置当前云环境

![输入图片说明](../doc/figures/iottencent_demo/072iottencent.png)

注意：第一次部署环境，图片里面的上传并部署会变成新建并部署。

![输入图片说明](../doc/figures/iottencent_demo/073iottencent.png)

![输入图片说明](../doc/figures/iottencent_demo/070iottencent.png)

等待大概1分钟左右，直到出现上传云函数成功：（注意：上传并部署由于网络问题可能会失败，看到上传云函数等字样代表上传部署成功，这里以iothub-publish为例）。

![输入图片说明](../doc/figures/iottencent_demo/074iottencent.png)

3.10 环境部署完成后，点击编译，然后真机调试会出现如下界面，上面两个都要出现

![输入图片说明](../doc/figures/iottencent_demo/075iottencent.png)
...
-   5.烧录
    ...
    ![输入图片说明](../doc/figures/iottencent_demo/076iottencent.png)