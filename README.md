...
-    第一种方式(推荐使用，使用IDE编译将在3.30号左右上线)：
     ...
     -    [运行第一个程序Hello world](helloworlddemo/README.md)
-    第二种方式(hb方式，只能在unbuntu下使用)：
...
-    [led实验](leddemo/README.md)
-    [蜂鸣器实验](beepdemo/README.md)
## WiFi_IoT网络通信实验<a name="section11660541593"></a>
-    [AT指令应用](doc/AT指令应用.md)
-    [LWIP协议的TCP/IP通信](lwipdemo/README.md)
-    [MQTT的通信实验](mqttdemo/README.md)
-    [Coap协议的通信实验](coapdemo/README.md)
## WiFi_IoT应用实践实验<a name="section11660541593"></a>
-    [Histreaming APP的智慧交通灯](histreamingdemo/README.md)
-    [华为云的智能交通灯上报](ocdemo/README.md)
-    [腾讯云的微信小程序开发及Hi3861板端互联](iottencentdemo/README.md)
-    [微信小程序基于UDP局域网和Hi3861板端互联](udpdemo/README.md)
## WiFi_IoT工程实验<a name="section11660541593"></a>
-    [交通灯实验](trafficlightdemo/README.md)
-    [环境检测实验](environmentdemo/README.md)
-    [NFC实验](nfcdemo/README.md)
